...
from lesson_005.painting import wall as pt_wall

sd.resolution = (1200, 600)
building_start_point = sd.get_point(x=250, y=10)
...
def draw_house():
    ...
    # рисуем крышу здания
    sd.polygon(point_list=roof_point_list, color=sd.COLOR_DARK_PURPLE, width=0)
    sd.polygon(point_list=roof_point_list, color=sd.COLOR_BLACK, width=3)
